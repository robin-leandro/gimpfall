...
def load_decklist_local(path, sheet_width_in=13, sheet_height_in=19, cardback_path=''):
	os.chdir(path)
	...
	arrange_cards_into_sheets(image_paths, image_names, sheet_width_in*PPI, sheet_height_in*PPI, cardback_path, 800, 1100)
